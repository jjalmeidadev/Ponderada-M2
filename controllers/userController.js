// Controlador de usuários com operações CRUD e autenticação
...
const login = async (req, res) => {
  ...
  if (user) {
    ...
    if (fullUser) {
      ...
      req.session.email = fullUser.email; // Armazena e-mail na sessão
      req.session.document = fullUser.document || ''; // Armazena documento na sessão
